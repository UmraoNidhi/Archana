...
public class VehicleAdapter extends RecyclerView.Adapter<VehicleAdapter.MyViewHolder> {
    ...
    VehicleListInterface interfaceVehicle;

    public VehicleAdapter(Context context, ArrayList<ProfileResult.Data.Vehicle> vehicleList, ProfileFragment activity) {
        this.mcontext = context;
        this.mVehicle = vehicleList;
        this.interfaceVehicle= activity;
    }
...
//            tvText.setOnClickListener(this);
        ...
        public void onClick(View v) {
            ...
            for(int i=0;i<keyList.size(); i++){
                ...
                interfaceVehicle.deleteVehicle(selectedPos);
            }
        }
    }
